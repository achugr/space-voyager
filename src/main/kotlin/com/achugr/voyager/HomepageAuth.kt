...
import jvmMain.space.jetbrains.api.runtime.helpers.SecureGcloudAppInstanceStorage
...
private suspend fun PipelineContext<Unit, ApplicationCall>.getSpaceTokenInfo(): SpaceTokenInfo? {
    if (config.tryGetString("mode") == "local") {
    ...
    return (context.request.parseAuthorizationHeader() as? HttpAuthHeader.Single)?.blob
